...
echo "Preprocess 3"
python criteo.py -p -i dataset/ctr/criteo/train.txt -s 4 --discrete_min_freq=50 --continue_min_freq=2 --continue_n_interval=100000 --split_by_field --drop_contin_feat 1>criteo_preprocess2.log 2>&1